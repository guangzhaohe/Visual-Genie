...
app = FastAPI(title="Unicorn Visual Genie API")

# --- STATE MANAGEMENT (In-Memory) ---
# This dictionary lives in RAM. It persists as long as the server is running.
session_state = {
    "groups": [],
...
async def get_file(path: str):
    ...
    # The middleware above will automatically attach the CORS headers
